const form1 = `
  <v-card  id="main-form" height="100%" class="mx-auto" elevation="2"  outlined  max-width="1100">
    ...
    <center>  
      <div id="logo">
        <img width="350px" src="/assets/img/body-hack.png" alt="image/png">
      </div>
    </center>
    ...
    computed: {
      currentTitle () {
        switch (this.step) {
          ...
          case 2: return 'MEDICAL INFORMATION'
          case 3: return 'REHAB INFORMATION'
          case 4: return 'OCUPATIONAL HISTORY'
          default: return 'COMMERCIAL INSURANCE - PATIENT & PAYOR INFORMATION FORM'
        }
      },
    },
});
